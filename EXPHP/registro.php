...
<body>
    <div class="form">
        <form action="" method="post">
            ...
            <div class="form-group">
                <input type="senha" name="senha" placeholder="Confirme sua senha" class="form-control" require>
            </div>
            <button class="btn font-weight-blod" name="submit">Registrar</button>
            <p> Voce ja tem uma conta?<a href="login.php"></a></p>
